    ...
    <div class="menu-list">
        ...
        <ul id="menu-content" class="menu-content collapse out">
            ...
            <li  data-toggle="collapse" data-target="#products" class="collapsed">
                <a href="<?php echo e(url('/')); ?>"><i class="fa fa-dashboard fa-lg"></i> Dashboard </a>
            </li>
            ...
            <li data-toggle="collapse" data-target="#service" class="collapsed">
                <a href="<?php echo e(url('/leereenheden')); ?>"><i class="fa fa-book fa-lg"></i> Leereenheden </a>
            </li>
            ...
            <li data-toggle="collapse" data-target="#new" class="collapsed">
                <a href="<?php echo e(url('/opdrachten')); ?>"><i class="fa fa-list-ul"></i> Opdrachten </a>
            </li>
            ...
            <li data-toggle="collapse" data-target="#products" class="collapsed active">
                <a href="<?php echo e(url('/feedback')); ?>"><i class="fa fa-comment fa-lg"></i> Feedback</a>
            </li>
